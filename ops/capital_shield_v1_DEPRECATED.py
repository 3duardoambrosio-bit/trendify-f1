# DEPRECATED: No usar. Migrar a capital_shield_v2.py
# Este archivo se eliminara en la proxima version.
from __future__ import annotations

import warnings
warnings.warn("capital_shield v1 is deprecated, use capital_shield_v2", DeprecationWarning, stacklevel=2)
